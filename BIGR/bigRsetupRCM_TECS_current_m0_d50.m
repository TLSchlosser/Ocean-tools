...
% load('TECS_disp_kelvin_180z_76x_sm2.mat')
% dispcurve(:,1)=2*pi./kelvin_L;
% dispcurve(:,2)=kelvin_omega;
% dispcurve=flipud(dispcurve);

load(['BIGC_Disp_Mode_',num2str(mode),'X_r07_Mean.mat'])
...
filein(12) = -3.6984e-9;%dispcurve(1,1);%-2*pi/200e5;%
...
% movefile('dispc.mat',['BIGC_Disp_Mode_',num2str(mode),'X_r07_Meanb.mat'])
pause(5)
movefile('uvwrp.mat',['BIGR_D1_Mode',num2str(mode),'X_r07_d50_check.mat'])
Cx=x;Cz=z;
save(['BIGR_D1_Mode',num2str(mode),'X_r07_d50_check.mat'],'Cx','Cz','vtemp','-append')
