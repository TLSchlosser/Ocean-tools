...
filein(12) = -3.1e-7;%dispcurve(1,1);%-2*pi/200e5;%
...
nsqr=N2_0_bigV(~isnan(N2_0_bigV(:,3)),3);
...
pause(5)
movefile('uvwrp.mat',['BIGR_D1_Mode',num2str(mode),'X_r07_d50_bigV_check.mat'])
Cx=x;Cz=z;
save(['BIGR_D1_Mode',num2str(mode),'X_r07_d50_bigV_check.mat'],'Cx','Cz','vtemp','-append')
